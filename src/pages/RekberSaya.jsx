...
function RekberSaya() {
    ...
    const latestBuyerOrderRef = useRef(null);
    const latestSellerOrderRef = useRef(null);
    ...
    useEffect(() => {
        ...
        latestBuyerOrderRef.current?.scrollIntoView({
            behavior: "smooth",
            block: "start"
        });
    ...
    useEffect(() => {
        ...
        latestSellerOrderRef.current?.scrollIntoView({
            behavior: "smooth",
            block: "start"
        });
    ...
    const sendChat = async (rekberId, isLocked) => {
        ...
        try {
            ...
            if (fileInputRefs.current[rekberId]) {

                fileInputRefs.current[rekberId].value = "";
                ...
                >
                    ...
                    {chatMedia[rekberId] && (
                        ...
                        >
                            ...
                            {chatMedia[rekberId].type.startsWith("image") ? (

                                <img
                                    src={URL.createObjectURL(chatMedia[rekberId])}
                                    alt="preview"
                                    style={{
                                        width: "150px",
                                        borderRadius: "12px"
        ...
        <div className="store">
            ...
            <div className="profile-page">
                ...
                <div className="profile-section">
                    ...
                    {userRekber.map((item, index) => (

                        <div
                            className="history-card"
                            key={item.id}
                            ref={index === 0 ? latestBuyerOrderRef : null}
                        >
                ...
                <div className="profile-section">
                    ...
                    {sellerRekber.map((item, index) => (

                        <div
                            className="history-card"
                            key={item.id}
                            ref={index === 0 ? latestSellerOrderRef : null}
                        >
